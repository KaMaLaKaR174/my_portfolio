        ...
        child: Column(
          ...
          children: [
            ...
            Text("An Android developer with decent programming skills seeking opportunities to work in a challenging environment and utilize my skills in achieving organizational goals.",
              ...
              style: TextStyle(
                color: Colors.grey,fontStyle: FontStyle.italic,fontSize: 18,fontWeight: FontWeight.w200,
              ),
            ),
            SizedBox(height: 12,),
...
//                SizedBox(width: 12,),
                GestureDetector(
                    ...
                    child: Image.asset("assets/github.png",height: 20,width: 20,)),
                SizedBox(width: 12,),
                GestureDetector(
                    onTap: (){
                ...
                GestureDetector(
                  onTap: (){
                    ...
                    child: Image.asset("assets/twitter.png",height: 20,width: 20,)),
                SizedBox(width: 12,),
                GestureDetector(
                    onTap: (){
                      _launchURL("https://join.skype.com/invite/WCxQY4DZvCid");
                    },
                    child: Image.asset("assets/skype.png",height: 20,width: 20,)),
                SizedBox(width: 12,),
                GestureDetector(
                  onTap: (){
                    _launchURL("https://www.instagram.com/kamalakar_mucharla_/?hl=en");
                  },
                  child: Image.asset("assets/instagram.png",height: 20,width: 20,
                  ),
                ),
                SizedBox(width: 12,),
              ],
